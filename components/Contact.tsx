      ...
      <div className='flex flex-col md:flex-row w-full gap-16 max-w-6xl md:flex-wrap'>
        ...
        <div className='flex flex-col md:flex-row items-center gap-4'>
          ...
          <div className='flex flex-col gap-2 text-center md:text-left'>
            ...
            <Link href='https://www.linkedin.com/in/matthewczencz/' target='_blank' className='text-lg hover:text-theme-primary'>/in/matthewczencz</Link>
          </div>
        </div>
        ...
        <div className='flex flex-col md:flex-row items-center gap-4'>
          ...
          <div className='flex flex-col gap-2 text-center md:text-left'>
            ...
            <Link href='https://github.com/mattczencz' target='_blank' className='text-lg hover:text-theme-primary'>github.com/mattczencz</Link>
          </div>
        </div>
      </div>
    </section>
